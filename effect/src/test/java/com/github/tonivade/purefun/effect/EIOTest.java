...
public class EIOTest {
  ...
  @Test
  public void asyncRight(@Mock Consumer1<? super Try<? extends Either<Throwable, Integer>>> callback) {
  ...
  @Test
  public void asyncLeft(@Mock Consumer1<? super Try<? extends Either<Throwable, Integer>>> callback) {
