...
public class WriterTTest {
  ...
  public void writerTest() {
    WriterT<Id<?>, Sequence<String>, Integer> writer =
        WriterT.<Id<?>, Sequence<String>, Integer>pure(monoid, 5)
        .flatMap(value -> lift(monoid, Tuple.of(listOf("add 5"), value + 5)))
        .flatMap(value -> lift(monoid, Tuple.of(listOf("plus 2"), value * 2)));
