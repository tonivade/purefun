...
public class KleisliTest {
  ...
  @Test
  public void compose() {
    Kleisli<Try<?>, String, Integer> toInt = Kleisli.lift(Integer::parseInt);
    Kleisli<Try<?>, Integer, Double> half = Kleisli.lift(i -> i / 2.);
  ...
  public void flatMap() {
    Kleisli<Try<?>, String, Integer> toInt = Kleisli.lift(Integer::parseInt);
    Kleisli<Try<?>, String, Double> toDouble = Kleisli.lift(Double::parseDouble);
