 ...
 */
package com.github.tonivade.purefun.transformers;
...
import com.github.tonivade.purefun.transformers.instances.EitherTInstances;
...
public class EitherTTest {
  ...
  public void monadErrorFuture() {
    ...
    MonadError<Higher1<Higher1<EitherT.µ, com.github.tonivade.purefun.monad.Future.µ>, Throwable>, Throwable> monadError =
