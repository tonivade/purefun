...
public class InmutableListTest {
  ...
  public void notEmptyList() {
    ...
    assertAll(() -> assertEquals(3, list.size()),
              ...
              () -> assertEquals(InmutableList.of("c"), list.drop(2)),
              () -> assertEquals(InmutableList.empty(), list.drop(10)),
              () -> assertEquals(InmutableList.of("a", "b", "c", "z"), list.append("z")),
              () -> assertEquals(InmutableList.of("a", "b", "c", "z"), list.appendAll(InmutableList.of("z"))),
  ...
  public void emptyList() {
    ...
    assertAll(() -> assertEquals(0, list.size()),
              ...
              () -> assertEquals(InmutableList.empty(), list.drop(1)),
              () -> assertEquals(InmutableList.of("z"), list.append("z")),
              () -> assertEquals(InmutableList.of("z"), list.appendAll(InmutableList.of("z"))),
