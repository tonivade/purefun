...
abstract class AbstractFlatMap<F extends Kind<F, ?>, A, B> {
  ...
  public <R extends Kind<F, B>> R fix(Function<? super Kind<F, ? extends B>, ? extends R> fixer) {
...
abstract class AbstractApply<F extends Kind<F, ?>, A> {
  ...
  public <R extends Kind<F, A>> R fix(Function<? super Kind<F, ? extends A>, ? extends R> fixer) {
    return run().fix(fixer);
  }
