...
public class TupleK2Test {
  ...
  public void tuple() {
    ...
    assertAll(() -> assertEquals(TupleK.of(some("value"), some(10)), tuple),
              () -> assertEquals(TupleK.of(some("VALUE"), some(10)), tuple.map1(functor(Option_.class), String::toUpperCase)),
              () -> assertEquals(TupleK.of(some("value"), some(100)), tuple.map2(functor(Option_.class), (i -> i * i))),
