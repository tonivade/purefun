...
public class SelectiveTest {
  ...
  public void select() {
    ...
    Higher1<IO_, Integer> left = monad.select(monad.pure(Either.left("1")), monad.pure(parseInt));
  ...
  public void branch() {
    ...
    Higher1<IO_, Integer> left = monad.branch(monad.pure(Either.left("1")), monad.pure(parseInt), monad.pure(countLetters));
  ...
  @Test
  public void ifS() {
    Higher1<IO_, String> left = monad.ifS(monad.pure(true), monad.pure("left"), monad.pure("right"));
  ...
  @Test
  public void andS() {
    Higher1<IO_, Boolean> and00 = monad.andS(monad.pure(false), monad.pure(false));
    Higher1<IO_, Boolean> and01 = monad.andS(monad.pure(false), monad.pure(true));
    Higher1<IO_, Boolean> and10 = monad.andS(monad.pure(true), monad.pure(false));
  ...
  @Test
  public void orS() {
    Higher1<IO_, Boolean> or00 = monad.orS(monad.pure(false), monad.pure(false));
    Higher1<IO_, Boolean> or01 = monad.orS(monad.pure(false), monad.pure(true));
    Higher1<IO_, Boolean> or10 = monad.orS(monad.pure(true), monad.pure(false));
