...
public interface WriterTInstances {
  ...
  static <F extends Kind, L> Monad<Higher1<Higher1<WriterT_, F>, L>> monad(Monoid<L> monoid, Monad<F> monadF) {
    return WriterTMonad.instance(checkNonNull(monoid), checkNonNull(monadF));
  }

  static <F extends Kind, L> MonadWriter<Higher1<Higher1<WriterT_, F>, L>, L> monadWriter(Monoid<L> monoid, Monad<F> monadF) {
    return WriterTMonadWriter.instance(checkNonNull(monoid), checkNonNull(monadF));
  }

  static <F extends Kind, L, E> MonadError<Higher1<Higher1<WriterT_, F>, L>, E> monadError(
      Monoid<L> monoid, MonadError<F, E> monadErrorF) {
    return WriterTMonadError.instance(checkNonNull(monoid), checkNonNull(monadErrorF));
  }
}

interface WriterTMonad<F extends Kind, L> extends Monad<Higher1<Higher1<WriterT_, F>, L>> {

  static <F extends Kind, L> Monad<Higher1<Higher1<WriterT_, F>, L>> instance(Monoid<L> monoid, Monad<F> monadF) {
...
interface WriterTMonadWriter<F extends Kind, L>
    extends MonadWriter<Higher1<Higher1<WriterT_, F>, L>, L>, WriterTMonad<F, L> {

  static <F extends Kind, L> MonadWriter<Higher1<Higher1<WriterT_, F>, L>, L> instance(Monoid<L> monoid, Monad<F> monadF) {
...
interface WriterTMonadError<F extends Kind, L, E>
    extends MonadError<Higher1<Higher1<WriterT_, F>, L>, E>, WriterTMonad<F, L> {

  static <F extends Kind, L, E> MonadError<Higher1<Higher1<WriterT_, F>, L>, E> instance(
      Monoid<L> monoid, MonadError<F, E> monadErrorF) {
  ...
  @Override
  default <A> Higher3<WriterT_, F, L, A> handleErrorWith(
