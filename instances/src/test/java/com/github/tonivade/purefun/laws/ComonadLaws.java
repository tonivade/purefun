...
public class ComonadLaws {
  ...
  public static <F> void verifyLaws(Comonad<F> comonad, Kind<F, String> value) {
    assertAll(
  ...
  private static <F, A> void extractCoflattenIdentity(Comonad<F> comonad, Kind<F, A> value) {
    assertEquals(value, comonad.extract(comonad.coflatten(value)), "extract coflatten identity");
  }

  private static <F, A> void mapCoflattenIdentity(Comonad<F> comonad, Kind<F, A> value) {
    assertEquals(value, comonad.map(comonad.coflatten(value), comonad::extract), "map coflatten identity");
  }

  private static <F, A, B> void mapCoflatMapCoherence(Comonad<F> comonad,
                                                                      Kind<F, A> value,
  ...
  private static <F, A> void comonadLeftIdentity(Comonad<F> comonad, Kind<F, A> value) {
    assertEquals(value, comonad.coflatMap(value, comonad::extract), "comonad left identity");
  }

  private static <F, A, B> void comonadRightIdentity(Comonad<F> comonad,
                                                                  Kind<F, A> value,
