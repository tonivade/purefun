...
public class MonadDeferTest {
  ...
  public void ioBracket() throws Exception {
    ...
    String result = bracket.fix(IOOf::narrowK).unsafeRunSync();
  ...
  public void ioBracketAcquireError() throws Exception {
    ...
    assertThrows(IllegalStateException.class, () -> bracket.fix(IOOf::narrowK).unsafeRunSync());
  ...
  public void ioBracketUseError() throws Exception {
    ...
    assertThrows(UnsupportedOperationException.class, () -> bracket.fix(IOOf::narrowK).unsafeRunSync());
  ...
  public void eitherTBracket() throws Exception {
    ...
    String result = bracket.fix(EitherTOf::narrowK).get().fix(IOOf::narrowK).unsafeRunSync();
  ...
  public void eitherTBracketAcquireError() throws Exception {
    ...
    assertThrows(IllegalStateException.class,
                 () -> bracket.fix(EitherTOf::narrowK).value().fix(IOOf::narrowK).unsafeRunSync());
  ...
  public void eitherTBracketAcquireError2() throws Exception {
    ...
    Throwable error = bracket.fix(EitherTOf::narrowK).getLeft().fix(IOOf::narrowK).unsafeRunSync();
  ...
  public void optionTBracket() throws Exception {
    ...
    String result = bracket.fix(OptionTOf::narrowK).get().fix(IOOf::narrowK).unsafeRunSync();
  ...
  public void optionTBracketAcquireError() throws Exception {
    ...
    NoSuchElementException error = assertThrows(NoSuchElementException.class,
                 () -> bracket.fix(OptionTOf::narrowK).get().fix(IOOf::narrowK).unsafeRunSync());
  ...
  public void zioBracket() throws Exception {
    ...
    Either<Throwable, String> result = bracket.fix(ZIOOf::narrowK).provide(nothing());
