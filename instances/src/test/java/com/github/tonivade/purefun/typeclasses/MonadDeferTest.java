...
public class MonadDeferTest {
  ...
  private MonadDefer<IO_> ioMonadDefer = Instances.<IO_>monadDefer();
  private MonadDefer<Kind<Kind<PureIO_, Void>, Throwable>> PureIOMonadDefer =
      new Instance<Kind<Kind<PureIO_, Void>, Throwable>>(){}.monadDefer();
  private MonadDefer<Kind<Kind<EitherT_, IO_>, Throwable>> eitherTMonadDefer =
      new Instance<Kind<Kind<EitherT_, IO_>, Throwable>>(){}.monadDefer(ioMonadDefer);
  private MonadDefer<Kind<OptionT_, IO_>> optionTMonadDefer =
      new Instance<Kind<OptionT_, IO_>>(){}.monadDefer(ioMonadDefer);
  ...
  public void eitherTBracket() throws Exception {
    Kind<Kind<Kind<EitherT_, IO_>, Throwable>, String> bracket =
        eitherTMonadDefer.bracket(EitherT.<IO_, Throwable, AutoCloseable>right(Instances.<IO_>monad(), resource),
                                                r -> EitherT.<IO_, Throwable, String>right(Instances.<IO_>monad(), "done"));
  ...
  public void eitherTBracketAcquireError() throws Exception {
    Kind<Kind<Kind<EitherT_, IO_>, Throwable>, String> bracket =
        eitherTMonadDefer.bracket(EitherT.<IO_, Throwable, AutoCloseable>left(Instances.<IO_>monad(), new IllegalStateException()),
                                                r -> EitherT.<IO_, Throwable, String>right(Instances.<IO_>monad(), "done"));
  ...
  public void optionTBracket() throws Exception {
    Kind<Kind<OptionT_, IO_>, String> bracket =
        optionTMonadDefer.bracket(OptionT.some(Instances.<IO_>monad(), resource),
                                  r -> OptionT.some(Instances.<IO_>monad(), "done"));
  ...
  public void optionTBracketAcquireError() throws Exception {
    Kind<Kind<OptionT_, IO_>, String> bracket =
        optionTMonadDefer.bracket(OptionT.<IO_, AutoCloseable>none(Instances.<IO_>monad()),
                                  r -> OptionT.some(Instances.<IO_>monad(), "done"));
  ...
  public void optionTBracketUseError() throws Exception {
    Kind<Kind<OptionT_, IO_>, String> bracket =
        optionTMonadDefer.bracket(OptionT.some(Instances.<IO_>monad(), resource),
                                  r -> OptionT.<IO_, String>none(Instances.<IO_>monad()));
